...
export PYTHONPATH=. && python scripts/relight_importance.py --ckpt "/home/barry/Desktop/other_code/VSR_benchmarks/TensoIR/log/VSR_logs/HPC-1-1/checkpoints/HPC-1-1_70000.th"\
 --config configs/multi_light_general/vsr.txt --batch_size 800